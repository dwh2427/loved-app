...
class CardsCreator{
	...
	bindEvents(){
		...
		$('#templates-list li').on('click', function(){
		...
		$('#current-font').on('click', function(){
		...
		$('#fonts-list li').on('click', function(){
		...
		$('#text-align li').on('click', function(){
		...
		$('#text-colors-list li').on('click', function(){
			$('#text-colors-list li').removeClass('active');
			$(this).addClass('active');
		...
		$('#stickers-list li').on('click', function(){
		...
		$('#base-colors-list li').on('click', function(){
			$('#base-colors-list li').removeClass('active');
			$(this).addClass('active');
		...
		$('#covers-list li').on('click', function(){
			this_.setCover($(this).attr('data-cover'))
		});



		$('#envelope-nav li').on('click', function(){
		...
		$('#envelope-color').on('input', function(){
		...
		$('#envelope-colors-list li').on('click', function(){
		...
		$('#envelope-liner-list li').on('click', function(){
