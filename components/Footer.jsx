...
export default function Footer() {
  return (
    <footer className="w-screen bg-[#ECFEFF]">
      <div className="mx-auto mt-4 flex max-w-[1495.9px] flex-col gap-y-6 py-4 md:mt-9 md:gap-y-8 xl:mt-[50px] xl:gap-y-[41.63px] xl:py-[50px]">
        ...
        <div className="relative h-10 w-40 px-[20px] xl:h-[66px] xl:w-[190.48px] xl:px-0">
          <Image src={Logo2} alt="Image" className="object-cover" fill />
        </div>
        <p className="px-[20px] text-[20.81px] font-[700] text-[#004318] xl:h-[75px] xl:w-[202px] xl:px-0 xl:leading-[74.28px]">
          © 2024 Loved Pty Ltd
        </p>
      </div>
    </footer>
